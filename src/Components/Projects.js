         ...
         <div className="container"  >
           ...
           <hr/>
                ...
                <EachProject address='https://todos-listing.netlify.app' img={Todos} text='Manage your day with list of todos.' heading='Todo list'/>
                    <EachProject address='https://scorekeeeper.netlify.app' img={ScoreKeeper} text='Track the score of 2 teams or players.' heading='Score-Keeper'  />
                    <EachProject address='https://calorie-track.netlify.app' img={CalorieTracker} text='Keep track of your daily calorie intake.' heading='Calorie-Tracker'  />
                    <EachProject address='https://book-game.netlify.app' img={BookGame} text='Play your favourite childhood book game.' heading='Book-Game'  />
                    <EachProject address='https://widgets-tj.netlify.app/' img={widgets} text='Use encyclopedia and translate text in 20 different languages.' heading='Trajour'  />
